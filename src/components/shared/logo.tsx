...
export function Logo({ children, className = "" }: LogoProps) {
  return (
    ...
    >
      <span className="relative grid size-9 shrink-0 place-items-center border border-ink bg-ink text-paper shadow-[3px_3px_0_rgba(184,134,63,0.72)] transition-all duration-300 group-hover:-translate-y-0.5 group-hover:translate-x-0.5 group-hover:bg-brass group-hover:text-ink group-hover:shadow-[1px_1px_0_rgba(18,24,31,0.8)]">
