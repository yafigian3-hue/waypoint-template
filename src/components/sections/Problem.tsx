        ...
        <div className="mt-12 grid grid-cols-1 gap-4 sm:mt-16 md:grid-cols-3">
          {content.problem.cards.map((card, i) => (
            <motion.article
              ...
              className="group border border-slate/20 bg-paper p-6 shadow-[6px_6px_0_rgba(18,24,31,0.08)] transition-all duration-300 hover:border-brass/60 hover:shadow-[7px_7px_0_rgba(18,24,31,0.1)] sm:p-7"
            >
